...
var Boot=mensBoot.filter(function(elem){
...
function clothingfun(){
  ...
  console.log(clothes)
  localStorage.setItem("menBoot",JSON.stringify(clothes))
  var clothsArr=JSON.parse(localStorage.getItem("menBoot"))
  display(clothsArr)
}
...
function shoesfun(){
  ...
  console.log(shoes)
  localStorage.setItem("menBoot",JSON.stringify(shoes))
  var shoesArr=JSON.parse(localStorage.getItem("menBoot"))
  display(shoesArr)
}
...
function slipperfun(){
  ...
  console.log(slipper)
  localStorage.setItem("menBoot",JSON.stringify(slipper))
  var slipperArr=JSON.parse(localStorage.getItem("menBoot"))
  display(slipperArr)
}
...
function sneakerfun(){
  ...
  console.log(sneaker)
  localStorage.setItem("menBoot",JSON.stringify(sneaker))
  var sneakerArr=JSON.parse(localStorage.getItem("menBoot"))
  display(sneakerArr)
}